...
public class ComponentDAOTest extends BaseDAOTest {
    ...
    private local.tin.tests.jetty.embedded.crud.models.data.product.Component dataObject;
    private UnitDAO mockedUnitDAO;
    private local.tin.tests.jetty.embedded.crud.models.domain.product.Unit mockedDomainUnit;
    private local.tin.tests.jetty.embedded.crud.models.data.product.Unit mockedDataUnit;
    ...
    public void setUp() throws DAOException {   
        ...
        dataObject = new local.tin.tests.jetty.embedded.crud.models.data.product.Component();
        mockedUnitDAO = mock(UnitDAO.class);
        when(mockedDAOFactory.getDAO(local.tin.tests.jetty.embedded.crud.models.data.product.Unit.class)).thenReturn(mockedUnitDAO);
        mockedDomainUnit = mock(local.tin.tests.jetty.embedded.crud.models.domain.product.Unit.class);
        mockedDataUnit = mock(local.tin.tests.jetty.embedded.crud.models.data.product.Unit.class);        
