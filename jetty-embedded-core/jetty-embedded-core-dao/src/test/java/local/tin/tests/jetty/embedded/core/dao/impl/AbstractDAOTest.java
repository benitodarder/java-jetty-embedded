...
@PrepareForTest({LoggerFactory.class, EntityManager.class, IllegalArgumentException.class, IIdentifiable.class})
public class AbstractDAOTest extends BaseDAOTest {
    ...
    private static LoggerFactory mockedLoggerFactory;
    ...
    public static void setUpClass() {
        ...
        mockedLoggerFactory = mock(LoggerFactory.class);
        PowerMockito.mockStatic(LoggerFactory.class);
        when(LoggerFactory.getLogger(IdentifiableDAO.class.getCanonicalName())).thenReturn(mockedLogger);
    ...
    public void getDomainObject_returns_expected_object() throws DAOException {
        ...
        local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable result = dao.getDomainObject(mockedAbstractDataObject, 0);
    ...
    public void create_assigns_id() throws DAOException {
        ...
        local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable result = dao.create(mockedAbstractDomainObject);
    ...
    public void retrieve_returns_object() throws DAOException {
        ...
        local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable result = dao.retrieve(mockedICompositeId);
...
//A 
    ...
    public void retrieveAll_returns_expected_query() throws DAOException {
        ...
        List<local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable> results = dao.retrieveAll();
    ...
    public void update_merges_object() throws DAOException {
        ...
        local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable result = dao.update(mockedAbstractDomainObject);
...
class AbstractDAOWrapperWithEmbeddedId extends IdentifiableDAO<local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable, local.tin.tests.jetty.embedded.core.dao.model.interfaces.IIdentifiable> {
    ...
    @Override
    protected local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable updateDomainObjectDepth0Fields(local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable domainObject, IIdentifiable dataObject) throws DAOException {
        return AbstractDAOTest.mockedAbstractDomainObject;
    }

    @Override
    protected local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable updateDomainObjectDeeperFields(local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable domainObject, IIdentifiable dataObject, int depth) throws DAOException {
        return AbstractDAOTest.mockedAbstractDomainObject;
    }

    @Override
    protected IIdentifiable updateDataObjectDepth0Fields(local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable domainObject, IIdentifiable dataObject) throws DAOException {
        return AbstractDAOTest.mockedAbstractDataObject;
    }

    @Override
    protected IIdentifiable updateDataObjectDeeperFields(local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable domainObject, IIdentifiable dataObject, int depth) throws DAOException {
        return AbstractDAOTest.mockedAbstractDataObject;
    }

    @Override
    protected local.tin.tests.jetty.embedded.core.models.domain.interfaces.IIdentifiable getDomainObjectNewInstance() {
        return AbstractDAOTest.mockedAbstractDomainObject;
    }
